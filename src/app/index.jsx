    ...
    <div class="flex flex-col lg:flex-row flex-wrap">
      <main class="p-12 md:p-16 lg:p-20 xl:p-24 w-screen max-w-none lg:max-w-prose lg:w-auto h-auto lg:h-screen lg:overflow-y-auto prose dark:prose-invert prose-green bg-white dark:bg-gray-900">
        ...
        <section>
          ...
          <ul>
            <li>
              A web browser which supports WebUSB (such as Google Chrome, Microsoft Edge, Opera), running on
        ...
        <section>
          ...
          <ol>
            ...
            <li>
              Then,{' '}
              <a href="https://youtube.com/clip/Ugkx1pbkpkvFU9gGsUwvkrl7yxx-SfHOZejM?si=nsJ0WJHJwS-rnHXL">
                quickly
              </a>{' '}
              connect the device to your computer using the USB-C port <strong>(port 2)</strong>.
            </li>
            <li>
              After a few seconds, the device should indicate it&apos;s in fastboot mode and show its serial
              number.
            </li>
          </ol>
          <img
        ...
        <section>
          <h2>Flashing</h2>
          <p>
            After your device is in fastboot mode, you can click the button to start flashing. A prompt may
            appear to select a device; choose the device labeled &quot;Android&quot;.
          </p>
          <p>
            The process can take 15+ minutes depending on your internet connection and system performance. Do
            not unplug the device until all steps are complete.
          </p>
        </section>
        <hr />
        ...
        <section>
          ...
          <p>
            Try using a different USB cable or USB port. Sometimes USB 2.0 ports work better than USB 3.0
            (blue) ports. If you&apos;re using a USB hub, try connecting the device directly to your
          ...
          <p>
            ...
            doesn&apos;t support newer displays. If a reflash doesn&apos;t fix the blank screen, then the
